...
- Edu-Sharing now opens in a new tab instead of an iframe
...
- Added a button to open the search in the iframe

### Changed

- Updated links to current Edu-Sharing standards
...
- Major refactoring to update the plugin to current Moodle CI requirements
...
- Updated logic to use the new edu-sharing activity plugin
